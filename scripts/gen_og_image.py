...
W, H = 1200, 630
top = (62, 30, 19)     # espresso #3E1E13
bot = (162, 78, 51)    # terracotta #A24E33
...
d.text((80, 70), "Megaverse Live", font=font(54), fill=(252, 222, 217))
...
d.text((80, 430), "Backend Interview Prep  |  English Coaching",
       font=font(38, bold=False), fill=(232, 192, 179))
